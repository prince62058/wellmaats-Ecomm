          ...
          >
                  ...
                  >
                    <div className="w-4 h-4 flex items-center justify-center shrink-0">
                      <DynamicIcon
                        icon={cat.icon}
                        categoryId={cat.id}
                        className={`w-4 h-4 object-contain ${isActive ? "text-forest opacity-100" : "text-forest/50 opacity-70"}`}
                      />
                    </div>
            ...
            {activeCategory && (
              <div className="flex-1 p-6 overflow-y-auto">
                <div className="flex items-center gap-2.5 mb-5 pb-3 border-b border-forest/8">
                  <div className="w-6 h-6 rounded-lg bg-leaf flex items-center justify-center text-forest overflow-hidden shrink-0">
                    <DynamicIcon
                      icon={activeCategory.icon}
                      categoryId={activeCategory.id}
                      className="w-4 h-4 object-contain text-forest"
                    />
                  </div>
