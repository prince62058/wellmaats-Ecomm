module.exports = {
  ...
  productCategories: [
    {
      id: "immunity-drops",
      label: "Immunity Drops",
      icon: "Shield",
      subCategories: [
        { id: "daily-immunity", label: "Daily Immunity" },
    ...
    },
    {
      ...
      subCategories: [
        ...
        { id: "constipation-care", label: "Constipation Care" },
      ],
    },
    {
      id: "liver-care",
    ...
    },
    {
      ...
      icon: "Brain",
      subCategories: [
        { id: "deep-sleep", label: "Deep Sleep" },
    ...
    },
    {
      ...
      icon: "Sparkles",
      subCategories: [
        { id: "hair-growth", label: "Hair Fall & Growth" },
        { id: "skin-glow", label: "Skin Glow & Acne" },
      ],
    },
    {
      id: "kids-wellness",
